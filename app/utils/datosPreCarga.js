...
module.exports.TiposEstadosApuesta =  [
...
module.exports.TiposMovimientos =  [
    {id : 1, descripcion : 'Retirada para Apuesta'},
    {id : 2, descripcion : 'Ingreso por Apuesta'},
    {id : 3, descripcion : 'Ingreso por Manual'}
];
...
module.exports.Jugadores =  [
          { id: 1, username: 'jdesande', password:'123456', Nombre: 'Jose Aurelio de Sande Villarroel', IdEstado: 1, CorreoExterno: 'aure.desande@gmail.com', IdRol: 1 },
          ...
          { id: 5, username: 'aolazaba', password:'123456', Nombre: 'Alejandro Olazabal Bourdet', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          ...
          { id: 8, username: 'ajimene1', password:'123456', Nombre: 'Ana Belén Jiménez González', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 9, username: 'aarevalo', password:'123456', Nombre: 'Ana Mª Arevalo De La Cruz', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 10, username: 'ccermeno', password:'123456', Nombre: 'Cayetana Cermeño Barona', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 11, username: 'Cnavarre', password:'123456', Nombre: 'Carlos Navarrete', IdEstado: 2, CorreoExterno: 'carlosnavec@gmail.com', IdRol: 2 },
          ...
          { id: 14, username: 'dcepedal', password:'123456', Nombre: 'David Cepedal Fernández', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 15, username: 'dsainz', password:'123456', Nombre: 'David Sainz Mera', IdEstado: 1, CorreoExterno: '', IdRol: 2 },
          { id: 16, username: 'DiegoMorano', password:'123456', Nombre: 'Diego Morano Lobo', IdEstado: 2, CorreoExterno: 'diegomorano@auna.com', IdRol: 2 },
          ...
          { id: 20, username: 'fblanco1', password:'123456', Nombre: 'Fernando Blanco Oroz', IdEstado: 2, CorreoExterno: 'byterider2006@gmail.com', IdRol: 2 },
          ...
          { id: 25, username: 'gcenjor', password:'123456', Nombre: 'Guillermo Cenjor Rodríguez', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          ...
          { id: 29, username: 'jros', password:'123456', Nombre: 'Jesus Ros Selgas', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          ...
          { id: 34, username: 'jromero4', password:'123456', Nombre: 'José Manuel Romero Ibañez', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          ...
          { id: 37, username: 'jfajardo', password:'123456', Nombre: 'Julio Fajardo Lazo', IdEstado: 2, CorreoExterno: 'fajardoju@hotmail.com', IdRol: 2 },
          { id: 38, username: 'kzetel', password:'123456', Nombre: 'Karina Zetel', IdEstado: 1, CorreoExterno: '', IdRol: 2 },
          { id: 39, username: 'Laura Vega', password:'123456', Nombre: 'Laura Vega', IdEstado: 2, CorreoExterno: 'voyasalirenagrosfera@hotmail.com', IdRol: 2 },
          ...
          { id: 42, username: 'lmartin4', password:'123456', Nombre: 'Luis Martín Romero', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          ...
          { id: 46, username: 'mperez2', password:'123456', Nombre: 'Mª Luisa Pérez Ayuso', IdEstado: 2, CorreoExterno: 'mperezayuso@gmail.com', IdRol: 2 },
          ...
          { id: 49, username: 'mmarti13', password:'123456', Nombre: 'Manuel Martínez Miralles', IdEstado: 2, CorreoExterno: 'manumm11@hotmail.com', IdRol: 2 },
          ...
          { id: 52, username: 'mpoveda', password:'123456', Nombre: 'Miguel Angel Poveda Mañosa', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 53, username: 'mmorale1', password:'123456', Nombre: 'Miguel Morales García', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          ...
          { id: 56, username: 'oserna', password:'123456', Nombre: 'Oscar Serna Serna', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          ...
          { id: 59, username: 'rcolomo', password:'123456', Nombre: 'Roberto Colomo Romero', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 60, username: 'rmolina', password:'123456', Nombre: 'Rocío Molina Utrera', IdEstado: 1, CorreoExterno: '', IdRol: 2 },
          { id: 61, username: 'racero', password:'123456', Nombre: 'Ruben Acero Herreros', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 62, username: 'srecio', password:'123456', Nombre: 'Sara Recio García', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 63, username: 'srodrig1', password:'123456', Nombre: 'Silvia Rodríguez Solano', IdEstado: 1, CorreoExterno: '', IdRol: 2 },
          { id: 64, username: 'Susana Fernandez', password:'123456', Nombre: 'Susana Fernandez', IdEstado: 2, CorreoExterno: 'sufers.es@gmail.com', IdRol: 2 },
          { id: 65, username: 'vormeno', password:'123456', Nombre: 'Vanesa Ormeño Elvar', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          ...
          { id: 69, username: 'bmunoz1', password:'123456', Nombre: 'Belen Muñoz', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 70, username: 'eserrano', password:'123456', Nombre: 'Eva Serrano', IdEstado: 1, CorreoExterno: '', IdRol: 2 },
          { id: 71, username: 'jmartin6', password:'123456', Nombre: 'Jose Javier Martín Carnes', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 72, username: 'mgomez3', password:'123456', Nombre: 'Mª Angeles Gómez Leira', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 73, username: 'calvare5', password:'123456', Nombre: 'Carlos Alvarez Beringola', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 74, username: 'mmarti11', password:'123456', Nombre: 'Mª Carmen Martín Soria', IdEstado: 1, CorreoExterno: '', IdRol: 2 },
          { id: 75, username: 'jgonza34', password:'123456', Nombre: 'Juan Pablo González Mier', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 76, username: 'jmoreno4', password:'123456', Nombre: 'Jose Luis Moreno Barriga', IdEstado: 1, CorreoExterno: '', IdRol: 2 },
          { id: 77, username: 'mferna27', password:'123456', Nombre: 'Miguel Ángel Fernández López', IdEstado: 2, CorreoExterno: 'miguelangel.mfernandez@gmail.com', IdRol: 2 },
          { id: 78, username: 'sronda', password:'123456', Nombre: 'Salvador Manuel Ronda Gomez', IdEstado: 1, CorreoExterno: '', IdRol: 2 },
          { id: 79, username: 'fcarmona', password:'123456', Nombre: 'Francisco Borja Carmona Castaño', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 80, username: 'rmarti17', password:'123456', Nombre: 'Rubén Martínez García', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 81, username: 'blopez5', password:'123456', Nombre: 'Beatriz López López', IdEstado: 2, CorreoExterno: 'beitaninfa@hotmail.com', IdRol: 2 },
          { id: 82, username: 'jmarti39', password:'123456', Nombre: 'Javier Martín Roncero', IdEstado: 2, CorreoExterno: 'jmarti135@gmail.com', IdRol: 2 },
          ...
          { id: 85, username: 'agarci42', password:'123456', Nombre: 'Alejandro García Perez', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          ...
          { id: 88, username: 'mperez39', password:'123456', Nombre: 'Mª Soledad Pérez Pérez', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 89, username: 'vastorga.ext', password:'123456', Nombre: 'Victor Astorga Acevedo', IdEstado: 2, CorreoExterno: 'victorastace@hotmail.com', IdRol: 2 },
          { id: 90, username: 'aalvare9', password:'123456', Nombre: 'Angel Alvarez Cabrera', IdEstado: 1, CorreoExterno: 'angealv@gmail.com', IdRol: 2 },
          { id: 91, username: 'asobrin1.ext', password:'123456', Nombre: 'Alvaro Sobrino Molina', IdEstado: 2, CorreoExterno: 'alvaro.sobrinom@gmail.com', IdRol: 2 },
          { id: 92, username: 'rdefruto', password:'123456', Nombre: 'Raul De Frutos', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 93, username: 'srebollo', password:'123456', Nombre: 'Sonia Rebollo Andrés', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 94, username: 'rvillalb', password:'123456', Nombre: 'Rosa María Villalba Conde', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          ...
          { id: 99, username: 'mvizcain', password:'123456', Nombre: 'Manuel Vizcaíno Serrano', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 100, username: 'rgomez6', password:'123456', Nombre: 'Rafael Gómez Del Prado', IdEstado: 1, CorreoExterno: '', IdRol: 2 },
          { id: 101, username: 'pvillaca', password:'123456', Nombre: 'Pedro Villacañas Landrove', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 102, username: 'rgomez8', password:'123456', Nombre: 'Raul Gomez Gonzalez', IdEstado: 2, CorreoExterno: 'rguacamayo@yahoo.es', IdRol: 2 },
          { id: 103, username: 'scrg', password:'123456', Nombre: 'Sergio Crespo Granjo', IdEstado: 2, CorreoExterno: '', IdRol: 2 },
          { id: 104, username: 'aperez11', password:'123456', Nombre: 'Agustín Pérez Vicente', IdEstado: 2, CorreoExterno: 'agus_perez2002@yahoo.es', IdRol: 2 },
